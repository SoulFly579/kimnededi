    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{url('admin/authors/create')}}" method="post">
                ...
                <div class="form-group">
                    <label>Yazar Kullanıcı Adı</label><br>
                ...
                <div class="form-group">
                    <label>Yazar Yaşadığı Yer</label><br>
                ...
                <div class="form-group">
                    <label>Yazar Telefon Numarası</label><br>
